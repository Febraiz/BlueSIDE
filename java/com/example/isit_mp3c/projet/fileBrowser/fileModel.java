    ...
    private void init() {
        ...
        */
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            //Init goes directly to BlueSIDE Folder !

            //mCurrentDir = Environment.getExternalStorageDirectory();
            mCurrentDir = new File(Environment.getExternalStorageDirectory().getPath() + "/Android/data/com.example.isit_mp3c.projet/files");
